-- El alta permanece pendiente hasta que Stripe confirma la matrícula.
...
begin
  ...
  update public.athletes set club_status=case when effective_waive then 'active' else 'pending_review' end where id=target_athlete_id;
