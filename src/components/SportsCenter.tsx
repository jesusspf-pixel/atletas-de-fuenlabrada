...
export default function SportsCenter() {
  ...
  const mainMenu=[...(profile.role==="coach"?["Inicio","Mi perfil","Mis grupos","Planificación","Asistencia","Carreras","Avisos","Club Challenge"]:["owner","admin"].includes(profile.role)?["Inicio","Atletas","Grupos","Cuotas","Carreras","Asistencia","Avisos","Invitaciones","Tienda","Configuración"]:["Inicio",profile.role==="parent"?"Mis atletas":"Mi perfil",...(profile.role==="adult_athlete"?["Mis menores"]:[]),"Carreras","Cuotas","Avisos","Tienda","Challenge"]),"Salir"];
