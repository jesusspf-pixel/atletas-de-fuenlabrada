...
export default function SelfAthleteRegistration({ onDone }: { onDone: () => void }) {
  const [form, setForm] = useState({ first_name: "", last_name: "", birth_date: "", federative_sex: "M", dni_nie: "", other_interest_info: "" });
