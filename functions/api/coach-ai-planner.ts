...
export const onRequestPost:PagesFunction<Env>=async({request,env})=>{
  ...
  const outputSchema={type:"object",additionalProperties:false,properties:{title:{type:"string"},sessions:{type:"object",additionalProperties:false,properties:Object.fromEntries(["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"].map(day=>[day,sessionSchema])),required:["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"]},rationale:{type:"string"}},required:["title","sessions","rationale"]};
